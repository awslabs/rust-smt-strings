...
//!
//! The [smt_strings] module implements the SMT-LIB functions defined
//! in the theory that do not use regular expressions.
//!
//! The [smt_regular_expressions] module implements the
...
//!
//! Module [regular_expressions] implements regular expression constructs, derivatives, and conversion
//! to automata. Module [automata] provides functions for constructing and minimizing automata.
//!
